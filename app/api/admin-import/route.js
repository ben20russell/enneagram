...
async function finalizeImport({
  ...
  if (shouldParseOnFinalize) {
    try {
      ...
      const parsedWithMl = mergeSanitizationIntoParsedPayload(
        parsedWithMlRaw,
        sanitizedPdf?.diagnostics || null,
      );
