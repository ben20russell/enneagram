...
async function importPdfJsLegacyBuild() {
  ...
  // pdfjs-dist v4+ is ESM-first and ships .mjs builds.
  const specifiers = ["pdfjs-dist/legacy/build/pdf.mjs", "pdfjs-dist/build/pdf.mjs", "pdfjs-dist/legacy/build/pdf.js"];
  let lastError = null;
